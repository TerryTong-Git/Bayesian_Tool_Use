...
\section{Experimental Results}\label{exp:0}
...
\end{equation}
This hypothesis is grounded in our theoretical framework (\cref{method}): code representations should yield higher mutual information with target algorithms than natural language, and deterministic solver execution should outperform stochastic LLM simulation.
...
\textbf{Wilcoxon Test.} Under the null that code and nl rank equally, the Wilcoxon Signed Rank test shows statistical significance in favor of the alternative.
