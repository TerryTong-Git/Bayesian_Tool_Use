...
% Camera-ready style with author information visible.
...
\icmltitlerunning{Is Code Better Than Language for Algorithmic Reasoning?}
...
\providecommand{\DeltaY}{\Delta(\mathcal{Y})}
...
\newcommand{\reviewfigurepair}[2]{%
  \begin{minipage}[t]{0.49\linewidth}
    \centering
    {\scriptsize\textbf{Old}}\par\vspace{1pt}
    \includegraphics[width=\linewidth]{#1}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.49\linewidth}
    \centering
    {\scriptsize\textbf{New}}\par\vspace{1pt}
...
\twocolumn[
\icmltitle{Is Code Better Than Language for Algorithmic Reasoning?}
