...
\begin{enumerate}
    ...
    \item \textbf{Empirical validation} (\cref{sec:empirical,fig:main,fig:per_task_accuracy}) demonstrating that our framework's ordering holds such that Route 1 $\leq$ Route 2 $<$ Route 3.
...
\begin{figure*}[t]
    ...
    \vspace{-3pt}
    \caption{\textbf{Code + Solver Execution performs better than Direct NL reasoning quantified by end-task accuracy overall and within paired instances.} Paired instance contrasts are shown in the bootstrap distributions. Results are averaged over CLRS30, NPHardEval, Custom Eval Suite, 3 seeds and 6 models. }
    \label{fig:main}
\end{figure*}
