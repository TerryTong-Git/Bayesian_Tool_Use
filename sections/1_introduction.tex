...
\begin{figure*}
    \centering
    \includegraphics[width=1\linewidth]{images/combined_accuracy_delta.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=1\linewidth]{images/main_combined.png}
