...
\begin{enumerate}
    ...
    \item A \textbf{systematic study} (\cref{sec:rep_analysis,sec:route2v3}) ruling out trace generation as the bottleneck and solidifying execution as the bottleneck in end-to-end algorithmic reasoning performance when using language.
\end{enumerate}
