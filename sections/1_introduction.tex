...
\begin{figure*}[t]
    \centering
    \vspace{-5pt}
    \includegraphics[width=0.85\textwidth]{images/combined_accuracy_delta.png}
    \vspace{-10pt}
