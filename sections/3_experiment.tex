...
\begin{figure*}[t]
    \centering
    \vspace{-5pt}
    \reviewfigurepair{images/translation_additivity.png}{images/review_20260528/fig8_additivity.pdf}
    \vspace{-3pt}
...
\paragraph{Results.}
Across $\sim$2000 samples per judge ($\sim$6000 total across three judges), discrimination accuracy is near chance (50\%), with 50\% included in the Wilson CI (\cref{fig:judge_barplot,fig:embedding_scatter}). The control discrimination between raw code and native NL is substantially higher (e.g., $\approx$82\%), indicating the judges can detect obvious representation differences but \emph{fail to distinguish translated vs.\ native NL}.
