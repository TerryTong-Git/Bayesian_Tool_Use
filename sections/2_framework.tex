...
\label{def:route}
We consider three reasoning pipelines (``routes''). Each route is represented as a pair $(E,\rho)$ consisting of a trace generator $E$ and an executor $\rho$, evaluated via the risk $R(E,\rho)$ and the computation-constrained
