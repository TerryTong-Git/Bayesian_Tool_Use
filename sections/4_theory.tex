...
In the 40-task analysis set, this recovery mass is 1.61\%, while the execution-win mass $\Pr(C)e_C$ is 33.08\%. This explains why deterministic execution typically achieves lower end-to-end error than simulation on the same generated code traces (\cref{fig:main}).
